...
(
    ...
    PUESTO VARCHAR2(10),
    CIJEFE NUMBER(10) DEFAULT NULL,
    CONSTRAINT jefe_fk FOREIGN KEY(CIJEFE) REFERENCES EMPLEADO(CI),
...
(
    ...
    CONSTRAINT log_empleado_fk FOREIGN KEY(CIEMPLEADO) REFERENCES EMPLEADO(CI),
    CONSTRAINT log_pk PRIMARY KEY(ID, CIEMPLEADO)
);
...
(
    IDLOTE NUMBER(10),
    CIRESPONSABLE NUMBER(10) NOT NULL ,
    EMAILPROVEEDOR VARCHAR2(50) NOT NULL,
    PESOINICIAL NUMBER(10) CHECK(PESOINICIAL > 0),
    PESOACTUAL NUMBER(10) CHECK(PESOACTUAL >= 0),
    ESTADO VARCHAR2(1) CHECK (ESTADO IN ('S', 'N')),
    FECHA DATE NOT NULL,
    CONSTRAINT responsable_lote_pk FOREIGN KEY(CIRESPONSABLE) REFERENCES EMPLEADO(CI),
    CONSTRAINT proveedor_lote_pk FOREIGN KEY(EMAILPROVEEDOR) REFERENCES PROVEEDOR(EMAIL),
    CONSTRAINT lotemadeta_pk PRIMARY KEY(IDLOTE)
);
...
(
	IDENERGIA NUMBER(10) NOT NULL REFERENCES COCCION(ID) PRIMARY KEY,
	FECHA DATE NOT NULL,
...
CREATE TABLE PAPEL
(
    IDPAPEL NUMBER(10) NOT NULL REFERENCES COCCION(ID) PRIMARY KEY,
...
(
    ID NUMBER(10),
    EMAILCLI VARCHAR2(50) NOT NULL REFERENCES CLIENTE(EMAIL),
    CIVENDEDOR NUMBER(10) NOT NULL REFERENCES EMPLEADO(CI),
    IDPAPEL NUMBER(10) NOT NULL REFERENCES PAPEL(IDPAPEL),
    PRECIO NUMBER(10) NOT NULL,
    FECHA DATE NOT NULL,
    CONSTRAINT venta_pk PRIMARY KEY(ID,EMAILCLI,CIVENDEDOR,IDPAPEL)
);
...
(
    ...
    EMAILCLI VARCHAR2(50) NOT NULL,
    CIVENDEDOR NUMBER(10) NOT NULL,
    IDPAPEL NUMBER(10) NOT NULL,
    PRECIO NUMBER(10) NOT NULL,
    FECHA DATE NOT NULL,
    CONSTRAINT venta_bono_fk FOREIGN KEY(IDVENTA,EMAILCLI, CIVENDEDOR, IDPAPEL) REFERENCES VENTA(ID,EMAILCLI,CIVENDEDOR,IDPAPEL),
    CONSTRAINT bono_pk PRIMARY KEY(ID,IDVENTA,EMAILCLI,CIVENDEDOR,IDPAPEL)
);

CREATE SEQUENCE BONO_EMPLEADO_ID_SEQ START WITH 1;
...
CREATE OR REPLACE TRIGGER BONO_EMPLEADO_ID BEFORE INSERT ON BONO_EMPLEADO
FOR EACH ROW

BEGIN
    SELECT BONO_EMPLEADO_ID_SEQ.NEXTVAL INTO :new.id FROM dual;
END;
/
ALTER TRIGGER BONO_EMPLEADO_ID ENABLE;
